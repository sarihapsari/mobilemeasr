...
st_weighted_statistic <- function(st,
                                  location,
                                  variable,
                                  sigma,
                                  verbose = T)
...
st_weighted_quantile_worker <- function(st,
                                        location,
                                        variable,
                                        sigma,
                                        verbose,
  ...
  # calc stats
  value <- matrixStats::weightedMedian(
    st_filt[[variable]],
    w = st_filt$weights,
    na.rm = T,
    ties = NULL
